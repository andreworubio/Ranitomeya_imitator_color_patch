...
names(files) <- "~/Google Drive/Projects/color_patch_trimmed_redo/orangevsred/"
...
write.csv(color_deseqsamples, "~/Google Drive/Projects/color_patch_trimmed_redo/results/color_samplespreadsheet.csv", row.names = F)
```
...
#melanin
color.melanin<- c("adcy7", "bbs1", "bbs5", "creb3l1", "dct", "egfr", "erbb3", "gfpt1", "herc2","irf4","lef1", "mitf", "mlana", "mlph", "mreg", "pmel","rab1a", "rabggta", "sfxn1", "tyr", "tyrp1", "vps18", "wnt10b", "wnt7a")

pheatmap(color.significant.color.mat[color.melanin,], cluster_cols = F, cluster_rows = T, scale = "row",labels_col = c("","Orange","","","Red",""),main = "Melanin/melanosome snthesis", border_color="Black", color = colorRampPalette(c("grey 60", "white", "black"))(50), angle_col = "0",annotation_legend = F, gaps_col = c(4),fontsize= 20, filename = "results/figures/orangevsred/publication/melanin_ovsr_blackvsorange.png")

#iridophore
color.iridophore<- c("adsl", "ak1", "anxa1", "dock7", "gart", "impdh2", "paics", "pgm2", "rpia", "shmt2")

pheatmap(color.significant.color.mat[color.iridophore,], cluster_cols = F, cluster_rows = T, scale = "row",labels_col = c("","Orange","","","Red",""),main = "Iridophore", border_color="Black", color = colorRampPalette(c("grey 60","white", "#3182bd"))(50), angle_col = "0",annotation_legend = F, gaps_col = c(4),fontsize= 25, filename = "results/figures/orangevsred/publication/iridophore_ovsr_blackvsorange.png")
#varotenoid
color.carotenoid<- c("aldh1a1","crabp2","gchfr", "mab21l2", "recql4", "rbp1", "rbp2", "ttc8")
pheatmap(color.significant.color.mat[color.carotenoid,], cluster_cols = F, cluster_rows = T, scale = "row",labels_col = c("","Orange","","","Red",""),main = "Pteridine & carotenoid Metabolism", border_color="Black", color = colorRampPalette(c("grey 60","white", "#de2d26"))(50), angle_col = "0",annotation_legend = F, gaps_col = c(4),fontsize= 25, filename = "results/figures/orangevsred/publication/carotenoid_ovsr_blackvsorange.png")
```